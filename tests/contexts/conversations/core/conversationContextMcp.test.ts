...
mock.module('@/contexts/conversations/services/conversationQueryService', () => {
  return {
    ConversationQueryService: MockQueryService,
  };
});

mock.module('@/contexts/conversations/services/conversationMemoryService', () => {
  return {
...
mock.module('@/contexts/conversations/resources/conversationResources', () => {
  return {
...
mock.module('@/contexts/conversations/tools/conversationTools', () => {
  return {
